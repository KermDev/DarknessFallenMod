...
{
    public class MiniSoul : ModProjectile
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Mini Soul");
        ...
        public override void Kill(int timeLeft)
        {
            SoundEngine.PlaySound(SoundID.Item14, Projectile.position);
                ...
                /*delegate WIP 
                {
                    for (int i = 0; i < 40; i++)
                    {
                        int num = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.RainbowRod, 0f, -2f, 0, default, 2f);
                        Main.dust[num].noGravity = true;
