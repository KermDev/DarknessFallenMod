...
namespace DarknessFallenMod.Items.MeleeWeapons.PhaloriteStabber
{
	...
	public class PhaloriteStabberProjectile : ModProjectile
	{
        ...
        {
            Projectile.NewProjectile(source, Projectile.Center, Projectile.velocity * 6, ModContent.ProjectileType<MeleeWeapons.PhaloriteSword.PhaloriteSwordProjectile>(), Projectile.damage, 0);
		}
