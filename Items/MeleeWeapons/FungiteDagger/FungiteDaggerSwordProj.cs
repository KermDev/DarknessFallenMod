...
namespace DarknessFallenMod.Items.MeleeWeapons.FungiteDagger
{
	...
	public class FungiteDaggerSwordProj : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Fungite Dagger");
		}
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Projectile.NewProjectileDirect(Projectile.GetSource_OnHit(target), target.Center, new Vector2(speed * randX, -speed * 2), ModContent.ProjectileType<FungiteSwordProjectile>(), dmg, knockback, Projectile.owner).netUpdate = true;
			Projectile.NewProjectileDirect(Projectile.GetSource_OnHit(target), target.Center, new Vector2(-speed * randX, -speed * 2), ModContent.ProjectileType<FungiteSwordProjectile>(), dmg, knockback, Projectile.owner).netUpdate = true;
		}
