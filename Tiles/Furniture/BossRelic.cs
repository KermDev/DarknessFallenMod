...
namespace DarknessFallenMod.Tiles.Furniture
{
	public abstract class BossRelic : ModTile
	{
		...
		public override string Texture => "Terraria/Images/Tiles_" + 617;
		...
		protected virtual int RelicItem => 0;
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 32, RelicItem);
