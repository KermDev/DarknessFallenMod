...
{
	public class BlueBeetleBannerTile : ModTile
	{
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (closer)
			{
				...
				{
					case 0:
						type = ModContent.NPCType<NPCs.BlueBeetle>();
						break;
					default:
						type = ModContent.NPCType<NPCs.BlueBeetle>();
						return;
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeable.Banners.BlueBeetleBanner>(), 1);
		}
	}
}