...
{
	public class AichapraBannerTile : ModTile
	{
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			if (closer)
			{
				...
				{
					case 0:
						type = ModContent.NPCType<NPCs.Aichapra>();
						break;
					default:
						type = ModContent.NPCType<NPCs.Aichapra>();
						return;
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeable.Banners.AichapraBanner>(), 1);
		}
	}
}